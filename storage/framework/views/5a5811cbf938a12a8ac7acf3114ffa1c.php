...
<?php endif; ?>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
            <h2 class="text-xl sm:text-2xl font-bold text-gray-800 dark:text-white mb-1">Edit Expense</h2>
            ...
            <form action="<?php echo e(route('expenses.update', $expense->id)); ?>" method="POST" enctype="multipart/form-data"
                class="space-y-6"
                onsubmit="sanitizeExpenseForm(this); return confirmAndLoad('Simpan perubahan pengeluaran ini?')">
                <?php echo csrf_field(); ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                    <div>
                        ...
                        <input type="date" name="expense_date"
                            value="<?php echo e(old('expense_date', $defaultDate ?? optional($expense->expense_date)->format('Y-m-d'))); ?>"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" name="name" value="<?php echo e(old('name', $expense->name)); ?>" required
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="number" name="qty" min="1"
                            value="<?php echo e(old('qty', (int) $expense->qty)); ?>" required
                            class="w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white text-sm" />
                        <?php $__errorArgs = ['qty'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" name="total"
                            value="<?php echo e(old('total', number_format((int) $expense->total, 0, ',', '.'))); ?>" required
                ...
                <div class="mt-4">
                    ...
                    <?php if($expense->attachment): ?>
                        <div class="text-xs mb-1">
                            File saat ini:
                            <a href="<?php echo e(route('expenses.attachment', $expense)); ?>" target="_blank"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mt-4">
                    ...
                    <textarea name="notes" rows="3"
                        class="w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white text-sm"
                        placeholder="Keterangan tambahan..."><?php echo e(old('notes', $expense->notes)); ?></textarea>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.action-button','data' => ['text' => 'Update','color' => 'green']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['text' => 'Update','color' => 'green']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH D:\Work\Project\immanuel-production-v2\resources\views\expenses\edit.blade.php ENDPATH**/ ?>