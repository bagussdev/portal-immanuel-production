...
<?php endif; ?>
    <div class="ip-page">
        ...
        <?php echo $__env->make('documents._form', ['kind' => 'quotation', 'document' => new \App\Models\Quotation(), 'action' => route('quotations.store'), 'method' => 'POST', 'submitLabel' => 'Simpan Draft', 'cancelUrl' => route('quotations.index')], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    </div>
 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH D:\Work\Project\immanuel-production-v2\resources\views\quotations\create.blade.php ENDPATH**/ ?>