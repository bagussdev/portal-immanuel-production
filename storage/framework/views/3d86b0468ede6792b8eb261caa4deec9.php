...
<?php endif; ?>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
            ...
            <form method="POST" action="<?php echo e(route('payroll.update', $payroll->id)); ?>"
                onsubmit="return confirmAndLoad('Apakah anda yakin mengedit gaji ini?')">
                <?php echo csrf_field(); ?>
                <?php echo method_field('PUT'); ?>

                <input type="hidden" name="month" value="<?php echo e($payroll->month); ?>">
                <input type="hidden" name="year" value="<?php echo e($payroll->year); ?>">
                ...
                <div class="mb-5">
                    ...
                    <select disabled
                        ...
                        <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($u->id); ?>" <?php if($u->id == $payroll->user_id): echo 'selected'; endif; ?>><?php echo e($u->name); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-6">
                    ...
                    <textarea name="notes" rows="3"
                        class="w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white text-sm"><?php echo e(old('notes', $payroll->notes)); ?></textarea>
                </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.action-button','data' => ['type' => 'submit','text' => 'Update','color' => 'blue']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'submit','text' => 'Update','color' => 'blue']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
                ...
                <?php if(!empty($oldBaseNames)): ?>
                    <?php $__currentLoopData = $oldBaseNames; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $nm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        addBaseRow(<?php echo json_encode($nm, 15, 512) ?>, <?php echo json_encode($oldBaseAmts[$i] ?? '', 15, 512) ?>,
                            <?php echo json_encode($oldBaseIds[$i] ?? '', 15, 512) ?>);
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php else: ?>
                    <?php $__currentLoopData = $baseItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $it): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        addBaseRow(<?php echo json_encode($it->name, 15, 512) ?>, <?php echo json_encode($it->amount, 15, 512) ?>,
                            <?php echo json_encode($it->id, 15, 512) ?>);
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php endif; ?>

                <?php if(!empty($oldDedNames)): ?>
                    <?php $__currentLoopData = $oldDedNames; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $nm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        addDedRow(<?php echo json_encode($nm, 15, 512) ?>, <?php echo json_encode($oldDedAmts[$i] ?? '', 15, 512) ?>, <?php echo json_encode($oldDedIds[$i] ?? '', 15, 512) ?>);
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php else: ?>
                    <?php $__currentLoopData = $deductionItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $it): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        addDedRow(<?php echo json_encode($it->name, 15, 512) ?>, <?php echo json_encode($it->amount, 15, 512) ?>,
                            <?php echo json_encode($it->id, 15, 512) ?>);
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php endif; ?>
...
<?php endif; ?>
<?php /**PATH D:\Work\Project\immanuel-production-v2\resources\views\payroll\edit.blade.php ENDPATH**/ ?>