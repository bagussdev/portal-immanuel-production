...
<?php endif; ?>
    <div class="ip-page">
        <div><p class="ip-kicker">Invoice</p><h1 class="ip-title">Buat invoice draft</h1><p class="ip-subtitle">Nomor resmi dibuat saat invoice diterbitkan.</p></div>
        <?php echo $__env->make('documents._form', ['kind' => 'invoice', 'document' => $invoice, 'action' => route('invoices.store'), 'method' => 'POST', 'submitLabel' => 'Simpan Draft', 'cancelUrl' => route('invoices.index')], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    </div>
 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH D:\Work\Project\immanuel-production-v2\resources\views\invoices\create.blade.php ENDPATH**/ ?>