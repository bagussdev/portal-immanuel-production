...
<li class="flex items-start gap-3 py-2 px-3 hover:bg-gray-50 dark:hover:bg-gray-800" data-id="<?php echo e($n->id); ?>">
    <div
    ...
    <div class="min-w-0 flex-1">
        <div class="flex items-center gap-2">
            <a href="<?php echo e($n->link ?? '#'); ?>" class="text-sm font-medium text-gray-800 dark:text-gray-200 truncate">
                <?php echo e($n->title ?? ucfirst(str_replace('_', ' ', $n->type))); ?>
        ...
        <?php if(!empty($n->message)): ?>
            <div class="text-xs text-gray-500 dark:text-gray-400 truncate"><?php echo e($n->message); ?></div>
        <?php endif; ?>
        <div class="mt-0.5 text-[11px] text-gray-400"><?php echo e($n->created_at->diffForHumans()); ?></div>
        <div class="mt-1">
            <button type="button"
                class="text-[11px] text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 underline"
                data-action="mark-read" data-id="<?php echo e($n->id); ?>">Tandai terbaca</button>
        </div>
    </div>
</li>
<?php /**PATH D:\Work\Project\immanuel-production-v2\resources\views\components\notifications\item.blade.php ENDPATH**/ ?>