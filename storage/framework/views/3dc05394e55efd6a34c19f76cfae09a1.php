<div class="relative">
    <button id="dateFilterToggle_<?php echo e($formId); ?>" type="button"
    ...
    <div id="dateFilterDropdown_<?php echo e($formId); ?>"
        ...
        <div class="flex flex-col gap-2">
            <div>
                <label for="start_date_<?php echo e($formId); ?>"
                    class="block text-xs font-medium text-gray-700 dark:text-gray-300">From:</label>
                <input type="date" id="start_date_<?php echo e($formId); ?>" name="start_date" value="<?php echo e($startDate); ?>"
            ...
            <div>
                <label for="end_date_<?php echo e($formId); ?>"
                    class="block text-xs font-medium text-gray-700 dark:text-gray-300">To:</label>
                <input type="date" id="end_date_<?php echo e($formId); ?>" name="end_date" value="<?php echo e($endDate); ?>"
                    class="mt-1 block w-full text-sm rounded-md border-gray-300 shadow-sm dark:bg-gray-700 dark:border-gray-600 dark:text-white">
            </div>
            <div class="flex justify-end gap-2 mt-2">
                <button type="button" id="clearDateFilterBtn_<?php echo e($formId); ?>"
...
<?php $__env->startPush('scripts'); ?>
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const formId = '<?php echo e($formId); ?>'; // Ambil ID form dari properti komponen
...
<?php $__env->stopPush(); ?>
<?php /**PATH D:\Work\Project\immanuel-production-v2\resources\views\components\date-filter-dropdown.blade.php ENDPATH**/ ?>