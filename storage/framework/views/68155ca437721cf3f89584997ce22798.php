...
<?php endif; ?>
    <div class="ip-page">
        <div><p class="ip-kicker"><?php echo e($quotation->quotation_number); ?></p><h1 class="ip-title">Edit quotation</h1></div>
        <?php echo $__env->make('documents._form', ['kind' => 'quotation', 'document' => $quotation, 'action' => route('quotations.update', $quotation), 'method' => 'PUT', 'submitLabel' => 'Simpan Perubahan', 'cancelUrl' => route('quotations.show', $quotation)], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    </div>
 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH D:\Work\Project\immanuel-production-v2\resources\views\quotations\edit.blade.php ENDPATH**/ ?>