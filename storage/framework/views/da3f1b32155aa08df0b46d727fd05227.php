...
<?php endif; ?>
        ...
        <div
            ...
            <div class="flex flex-row gap-2 sm:gap-3 items-start sm:items-center text-sm">
                <form method="GET" action="<?php echo e(route('client.index')); ?>" class="flex gap-2 items-center"
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('createclient')): ?>
                    <a href="<?php echo e(route('client.create')); ?>" onclick="showFullScreenLoader();"
                ...
                <div class="overflow-hidden shadow rounded-lg" id="clientList" data-list>
                    <table
                        ...
                        <thead
                            ...
                            <tr>
                                ...
                                <th class="px-4 py-3 cursor-pointer sort" data-sort="name">Name <span
                                        class="sort-icon"></span></th>
                                <th class="px-4 py-3 cursor-pointer sort" data-sort="company">Company <span
                                        class="sort-icon"></span></th>
                                <th class="px-4 py-3 cursor-pointer sort" data-sort="email">Email <span
                                        class="sort-icon"></span></th>
                                <th class="px-4 py-3 cursor-pointer sort" data-sort="phone">Phone <span
                                        class="sort-icon"></span></th>
                        ...
                        <tbody id="clientBody"
                            ...
                            data-changes-url="<?php echo e(route('client.sync.changes', request()->only('search'))); ?>"
                            data-rows-url="<?php echo e(route('client.rows')); ?>">
                            <?php $__empty_1 = true; $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr data-id="<?php echo e($client->id); ?>">
                                    <td class="px-4 py-3 text-left no">
                                        <?php echo e($loop->iteration + ($clients instanceof \Illuminate\Pagination\LengthAwarePaginator ? ($clients->currentPage() - 1) * $clients->perPage() : 0)); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.per-page-selector','data' => ['route' => 'client.index','perPage' => $perPage,'search' => $search,'items' => $clients]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['route' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('client.index'),'perPage' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($perPage),'search' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($search),'items' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($clients)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH D:\Work\Project\immanuel-production-v2\resources\views\client\index.blade.php ENDPATH**/ ?>