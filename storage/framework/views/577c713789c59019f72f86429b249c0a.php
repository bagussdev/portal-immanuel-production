...
<?php endif; ?>
    <div class="ip-page max-w-4xl"><div><p class="ip-kicker">Detail rekening</p><h1 class="ip-title">Tambah profil rekening</h1><p class="ip-subtitle">Isi hanya informasi yang ingin ditampilkan pada quotation dan invoice.</p></div>
        <?php echo $__env->make('bank-details._form', ['action' => route('bank-details.store'), 'method' => 'POST', 'submitLabel' => 'Simpan rekening'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    </div>
 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH D:\Work\Project\immanuel-production-v2\resources\views\bank-details\create.blade.php ENDPATH**/ ?>