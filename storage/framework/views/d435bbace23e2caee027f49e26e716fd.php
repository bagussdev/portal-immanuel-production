    ...
    <section class="grid w-full max-w-5xl overflow-hidden rounded-[2rem] border border-sky-100 bg-white shadow-[0_32px_90px_-35px_rgba(15,23,42,.35)] lg:grid-cols-[.82fr_1.18fr]">
        ...
        <div class="flex min-h-[660px] items-center px-6 py-10 sm:px-12 lg:px-16" x-data="{ showPassword: false, showConfirmation: false }">
            <div class="mx-auto w-full max-w-md">
                ...
                <form method="POST" action="<?php echo e(route('password.store')); ?>" class="mt-7 space-y-4" onsubmit="showFullScreenLoader();">
                    <?php echo csrf_field(); ?>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input id="email" class="ip-input min-h-12 bg-slate-50 pl-12 text-slate-500" type="email" name="email" value="<?php echo e(old('email', $request->email)); ?>" required readonly autocomplete="username">
                        </div>
                    </div>
                ...
                <p class="mt-6 text-center text-xs leading-5 text-slate-400">Tidak meminta perubahan password?<br><a href="<?php echo e(route('login')); ?>" class="font-extrabold text-sky-700 hover:text-sky-900">Kembali ke halaman login</a></p>
            </div>
        </div>
    </section>
...
<?php endif; ?>
<?php /**PATH D:\Work\Project\immanuel-production-v2\resources\views/auth/reset-password.blade.php ENDPATH**/ ?>