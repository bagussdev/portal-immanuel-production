...
<?php endif; ?>
    <div class="ip-page max-w-4xl"><div><p class="ip-kicker"><?php echo e($bankDetail->label); ?></p><h1 class="ip-title">Edit profil rekening</h1><p class="ip-subtitle">Perubahan berlaku pada PDF dokumen yang menggunakan profil ini.</p></div>
        <?php echo $__env->make('bank-details._form', ['action' => route('bank-details.update', $bankDetail), 'method' => 'PUT', 'submitLabel' => 'Simpan perubahan'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    </div>
 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH D:\Work\Project\immanuel-production-v2\resources\views/bank-details/edit.blade.php ENDPATH**/ ?>