    ...
    <div class="content">
                    ...
                    <td style="width:50%; vertical-align:top;">
                        <table>
                            <tr>
                                ...
                                <td>:
                                    {{ $payroll->payroll_no ?? 'IMP/' . sprintf('%02d/%02d/PYR%04d', $pMonth, $pYear % 100, $payroll->id) }}
                                </td </tr>
                            <tr>
        ...
        <table class="items">
            ...
            <tbody>
                ...
                {{-- Base (multi-row) --}}
                @forelse ($baseItems as $it)
                    <tr>
                        <td>{{ $rowNo++ }}</td>
                        <td>{{ $it->name ?: 'Gaji Pokok' }}</td>
                        <td style="text-align:right;">{{ $idr($it->amount) }}</td>
                    </tr>
                @empty
                    {{-- fallback kalau tidak ada base item tapi baseTotal > 0 --}}
                    @if ($baseTotal > 0)
                        <tr>
                            <td>{{ $rowNo++ }}</td>
                            <td>Gaji Pokok</td>
                            <td style="text-align:right;">{{ $idr($baseTotal) }}</td>
                        </tr>
                    @endif
                @endforelse
                ...
                <tr>
                    ...
                    <td style="text-align:right;"><strong>{{ $idr($baseTotal) }}</strong></td>
                </tr>
                <tr>
                    <td></td>
                    <td style="text-align:right;"><strong>Total Potongan</strong></td>
                    <td style="text-align:right;"><strong>- {{ $idr($dedTotal) }}</strong></td>
                </tr>
                <tr>
                    <td></td>
                    <td style="text-align:right;"><strong>Diterima (Net)</strong></td>
                    <td style="text-align:right;"><strong>{{ $idr($net) }}</strong></td>
                </tr>
            </tbody>
        </table>
        ...
        <div class="summary">
            ...
            <table>
                <tr>
                    <td>Total Base</td>
                    <td>:</td>
                    <td>Rp {{ $idr($baseTotal) }}</td>
                </tr>
                <tr>
                    <td>Total Potongan</td>
                    <td>:</td>
                    <td>- Rp {{ $idr($dedTotal) }}</td>
                </tr>
                <tr class="emph">
                    <td><strong>Diterima (Net)</strong></td>
                    <td>:</td>
                    <td><strong>Rp {{ $idr($net) }}</strong></td>
                </tr>
            </table>
        </div>
