...
<div class="ip-page">
    ...
    <div class="ip-card p-3 md:hidden">
        ...
        <div class="grid grid-cols-3 gap-2">
            ...
            <x-sort-link column="document_date" label="Quotation" :current="$sort" :direction="$direction" compact />
