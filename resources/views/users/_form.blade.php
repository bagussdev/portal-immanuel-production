@php
    ...
    $profileUrl = $editing && $user->profile_photo_path ? route('users.photo', ['user' => $user, 'kind' => 'profile', 'v' => $imageVersion]) : null;
    $ktpUrl = $editing && $user->ktp_photo_path ? route('users.photo', ['user' => $user, 'kind' => 'ktp', 'v' => $imageVersion]) : null;
@endphp
