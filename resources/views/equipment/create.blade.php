                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <x-text-input id="serial_number" name="serial_number" type="text"
                                    class="mt-1 block w-full" :value="old('serial_number')" />
                            </div>
                        </div>
                        ...
                        <div class="md:col-span-2 grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div>
                                ...
                                <x-text-input id="qty" name="qty" type="number" min="1"
                                    class="mt-1 block w-full" :value="old('qty')" required />
                            </div>
                                ...
                                <select id="location" name="location" required
                                    ...
                                    @foreach ($gudangs as $gudang)
                                        <option value="{{ $gudang->id }}"
                                            {{ old('location') == $gudang->id ? 'selected' : '' }}>
                                            {{ $gudang->name }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea id="notes" name="notes" rows="3"
                                class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-700 dark:text-white focus:ring-blue-500">{{ old('notes') }}</textarea>
                        </div>
                    </div>
