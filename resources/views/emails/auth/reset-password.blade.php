    ...
    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background:#f0f9ff;">
        <tr>
            <td align="center" style="padding:32px 16px;">
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="max-width:620px;background:#ffffff;border:1px solid #dbeafe;border-radius:24px;overflow:hidden;box-shadow:0 18px 45px rgba(15,23,42,.12);">
                    ...
                    <tr>
                        <td style="background:#08111f;padding:28px 36px;text-align:center;">
                            <img src="{{ asset('assets/brand/immanuel-production-white-logo.png') }}" width="150" alt="Immanuel Production" style="display:block;width:150px;max-width:100%;height:auto;margin:0 auto 10px;">
                    ...
                    <tr>
                        <td style="padding:40px 42px 20px;">
                            ...
                            <p style="margin:0 0 16px;font-size:15px;line-height:1.75;color:#475569;">Halo <strong style="color:#0f172a;">{{ $recipientName }}</strong>,</p>
                    ...
                    <tr>
                        <td align="center" style="padding:12px 42px 26px;">
                            <a href="{{ $resetUrl }}" style="display:inline-block;border-radius:12px;background:#0284c7;color:#ffffff;text-decoration:none;font-size:15px;font-weight:800;padding:15px 28px;box-shadow:0 8px 18px rgba(2,132,199,.22);">Buat Password Baru</a>
                        </td>
                    </tr>
                    <tr>
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:14px;">
                                <tr>
                                    <td style="padding:18px 20px;font-size:13px;line-height:1.65;color:#64748b;">
                                        <strong style="display:block;margin-bottom:4px;color:#334155;">Tautan berlaku {{ $expiresIn }} menit</strong>
                    ...
                    <tr>
                        <td style="padding:0 42px 34px;">
                            ...
                            <p style="margin:0;padding:12px 14px;border-radius:10px;background:#f1f5f9;font-size:11px;line-height:1.6;color:#0369a1;word-break:break-all;">{{ $resetUrl }}</p>
                ...
                <p style="margin:18px 0 0;font-size:11px;color:#94a3b8;">&copy; {{ date('Y') }} Immanuel Production</p>
            </td>
        </tr>
    </table>
</body>
